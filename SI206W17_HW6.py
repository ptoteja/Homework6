...
programmers = [Student(*i) for i in student_tups_list]
print(programmers)
...
names_and_productivities = [(a, c/b) for (a,b,c) in student_tups_list]
...
def main_filterer(list_of_file_names):
    return len_check(readfiles(list_of_file_names))
